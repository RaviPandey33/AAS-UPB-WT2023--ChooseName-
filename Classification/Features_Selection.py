...
class ClassifierTrainer_with_Feature_Selection:
    def __init__(self, ELA_Data, ERT_Data, target_columns, direction):
        """
        ...
        Args:
            ...
            direction (string): Defines the direction of the SequentialFeatureSelector() method.
        """
    ...
    def _train_classifier(self, classifier, name, Y_encoded):
        ...
        Args:
            ...
            name (string): Name of the classifier being used.
        ...
        cv_strategy = StratifiedKFold(n_splits=10) # To fix the step size
        sfs = SequentialFeatureSelector(classifier, n_features_to_select = 'auto', direction = self.direction, scoring = 'accuracy', cv = cv_strategy)
