...
class ClassifierTrainer_LeaveOneValidation: # Classifier Trainer Normal
    def __init__(self, ELA_Data, ERT_Data, target_columns):
        ...
        self.rf_classifier = None # Randome Forest Classifier
        self.svm_classifier = None # SVM Classifier
        self.xgb_classifier = None # XgBoost Classifier
    ...
    def _train_classifier(self, classifier, name, Y_encoded):
        ...
        like accuracy_score, f1_score, recall_score and confusion matrix. 
